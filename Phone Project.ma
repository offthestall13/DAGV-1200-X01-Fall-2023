...
//Last modified: Thu, Dec 07, 2023 11:02:46 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "F499AB3B-414F-6BD3-93C8-809D39E1C369";
createNode transform -s -n "persp";
	rename -uid "FCBD54D7-4A25-4208-C476-619EB2B024BA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -24.220083278867115 9.1342311097985345 -50.251374187701181 ;
	setAttr ".r" -type "double3" -6.9383527290408136 -513.3999999999113 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "422F95A0-4923-8022-F745-359A217EE076";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 55.543883066239133;
...
createNode transform -n "pCube2";
	...
	setAttr ".t" -type "double3" 0 2.8352569898519926 0 ;
	setAttr ".r" -type "double3" 0 0 111.23621992758385 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6DE517BD-4BFF-BC94-85C6-75ADD0310DDF";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode lightEditor -n "lightEditor";
	rename -uid "BFCCE176-4C2D-319E-C918-F1BA471F73C0";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "52762B98-46A0-6086-1C1D-BCBE2800A144";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BE6F7A7F-428F-80F2-6AA2-4B97EF52313C";
createNode displayLayerManager -n "layerManager";
	rename -uid "5D094B45-496C-D773-01B4-9EB10F2CF712";
createNode displayLayer -n "defaultLayer";
	rename -uid "B5EAD869-45FF-2ECD-4FC9-C9B25D2522F1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A2A6EA14-4CA5-45CC-9196-FBA537E923A9";
...
createNode polyTweak -n "polyTweak2";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[32]" -type "float3" 0.097912394 0 -0.095474787 ;
	setAttr ".tk[33]" -type "float3" 0.097912401 0 0.095474787 ;
	setAttr ".tk[34]" -type "float3" -0.097912401 0 -0.095474787 ;
	setAttr ".tk[35]" -type "float3" -0.097912401 0 0.095474787 ;
...
connectAttr "pCube2Shape.wm" "polySplitRing16.mp";
connectAttr "polySplitRing16.out" "polySplitRing17.ip";
connectAttr "pCube2Shape.wm" "polySplitRing17.mp";
...
connectAttr "pCube2Shape.iog" "aiStandardSurface1SG.dsm" -na;
